...
<body class="bg-gray-800 font-sans leading-normal tracking-normal mt-12">
    ...
    foreach ($showDetails as $booking) {
        ...
        echo '<td class="py-2 px-4"><a href="' . $siteurl . '/ticket/ticket.php?booked_seat=' . urlencode($booking['quantity']) . '" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Print Ticket</a> </td>';
        echo '</tr>';
